...
# This ensures your keys are secure and not hardcoded
SUPABASE_URL = os.getenv("https://ijfowsrtiqifdbcwgllt.supabase.co")
SUPABASE_KEY = os.getenv("sb_secret_tHlIGiZpqtuOqV5mWHR3lg__QR-GcpW")
GEMINI_API_KEY = os.getenv("AIzaSyAgNUZjyxSMDBVizQFR_d7VK29hQUSzkn0")
